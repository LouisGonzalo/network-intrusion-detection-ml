...
|-----|------|-----|
| ![DNN](results/dnn_training_curves.png.png) | ![CNN](results/cnn_training_curves.png.png) | ![LSTM](results/lstm_training_curves.png.png) | ![CNN-LSTM](results/cnn_lstm_training_curves.png) |
